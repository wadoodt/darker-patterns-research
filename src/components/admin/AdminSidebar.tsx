...
import { BarChart3, FileCheck, FileText, Home, ListChecks, Palette } from 'lucide-react';
...
const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { href: '/admin/revisions', label: 'Revisions', tooltip: 'Revisions', icon: FileText, adminOnly: false },
