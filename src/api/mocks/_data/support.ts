...
export const mockKnowledgeBaseArticles = [
    {
        ...
        translations: {
            ...
            es: {
                ...
                description: 'Una guía sobre cómo conectar tu cuenta con otros servicios.',
    ...
    },
    {
        ...
        translations: {
            ...
            es: {
                ...
                description: 'Aprende a crear flujos de trabajo de automatización complejos.',
    ...
    },
    {
        ...
        description: 'Deep dive into the metrics and what they mean for your campaigns.',
        category: 'Analytics',
        url: '#',
        translations: {
            en: {
            ...
            es: {
                ...
                description: 'Profundiza en las métricas y lo que significan para tus campañas.',
                category: 'Analíticas',
...
export const mockSupportTickets: SupportTicket[] = [
    {
        ...
        messages: [
            { author: 'user', content: 'I am trying to connect my Gmail account from the integrations page, but I keep getting an authentication error. I have double-checked my password and even tried an app password. Can you help?', createdAt: '2023-10-26T10:00:00Z' },
        ],
    },
    {
        id: 'tkt-2',
        ...
        messages: [
            { author: 'user', content: 'Is it possible to create an automation rule that tags a user based on which link they click in an email? I want to segment my audience based on their interests.', createdAt: '2023-10-25T14:30:00Z' },
            { author: 'support', content: 'Yes, that is possible! You can use our link-click trigger in the automation builder. Let me know if you need help setting it up.', createdAt: '2023-10-26T11:00:00Z' },
        ],
    },
    {
        id: 'tkt-3',
        ...
        messages: [
            { author: 'user', content: 'I was charged twice for my subscription this month. Please investigate and issue a refund.', createdAt: '2023-10-24T09:00:00Z' },
            { author: 'support', content: 'Apologies for the error. I have processed a refund for the duplicate charge. It should appear on your statement in 3-5 business days.', createdAt: '2023-10-25T17:45:00Z' },
        ],
    },
    {
        id: 'tkt-4',
        ...
        messages: [
            { author: 'user', content: 'The app is great, but my eyes would really appreciate a dark mode. Any plans to add this?', createdAt: '2023-10-27T11:20:00Z' },
        ],
    },
];
