...
export const mockSupportTickets: SupportTicket[] = [
    {
        ...
        message: 'I am trying to connect my Gmail account from the integrations page, but I keep getting an authentication error. I have double-checked my password and even tried an app password. Can you help?',
        status: 'open',
    ...
    },
    {
        ...
        message: 'Is it possible to create an automation rule that tags a user based on which link they click in an email? I want to segment my audience based on their interests.',
        status: 'in_progress',
    ...
    },
    {
        ...
        message: 'I was charged twice for my subscription this month. Please investigate and issue a refund.',
        status: 'closed',
    ...
    },
    {
        ...
        message: 'The app is great, but my eyes would really appreciate a dark mode. Any plans to add this?',
        status: 'open',
