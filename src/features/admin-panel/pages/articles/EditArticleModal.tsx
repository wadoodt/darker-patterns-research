          ...
          >
            <Tabs.List>
              <Tabs.Trigger value="en">
                {t("articlesPage.english")}
              </Tabs.Trigger>
              <Tabs.Trigger value="es">
                {t("articlesPage.spanish")}
              </Tabs.Trigger>
            </Tabs.List>
            <Tabs.Content value="en">
              <Box my="4">
                <TextField.Root
                  ...
                  onChange={(e) =>
                    handleFieldChange("en", "title", e.target.value)
                  }
                  mb="2"
                />
                <TextField.Root
                  placeholder={t("articlesPage.category")}
                  value={editingArticle.translations.en.category}
                  onChange={(e) =>
                ...
                <TextField.Root
                  ...
                  value={editingArticle.translations.en.description}
                  onChange={(e) =>
                ...
                <TextArea
                  ...
                  value={editingArticle.translations.en.body}
                  onChange={(e) =>
                    handleFieldChange("en", "body", e.target.value)
                  }
                  rows={6}
                />
              </Box>
            ...
            <Tabs.Content value="es">
              <Box my="4">
                <TextField.Root
                  placeholder={t("articlesPage.title")}
                  value={editingArticle.translations.es.title}
                  onChange={(e) =>
                    handleFieldChange("es", "title", e.target.value)
                  }
                  mb="2"
                />
                <TextField.Root
                  placeholder={t("articlesPage.category")}
                  value={editingArticle.translations.es.category}
                  onChange={(e) =>
                ...
                <TextField.Root
                  placeholder={t("articlesPage.description")}
                  value={editingArticle.translations.es.description}
                  onChange={(e) =>
                ...
                <TextArea
                  placeholder={t("articlesPage.body")}
                  value={editingArticle.translations.es.body}
                  onChange={(e) =>
                    handleFieldChange("es", "body", e.target.value)
                  }
                  rows={6}
                />
              </Box>
