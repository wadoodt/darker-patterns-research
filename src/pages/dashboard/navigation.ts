...
export const dashboardNavigation: NavigationItem[] = [
  ...
  {
    name: "sidebar.dashboard.billing",
  ...
  {
    name: "sidebar.dashboard.settings",
  ...
  {
    name: "sidebar.dashboard.support",
...
export const adminNavigation: NavigationItem[] = [
  ...
  },
  {
    ...
    icon: Users,
    component: AdminPanelUsersPage,
    roles: ["super-admin", "qa"],
  },
  {
    name: "sidebar.admin.tickets",
  ...
  },
  {
    ...
    icon: Shield,
    component: AdminPanelSettingsPage,
    roles: ["super-admin", "qa"],
  },
  {
    name: "sidebar.admin.infra",
    path: "/admin-panel/infra",
